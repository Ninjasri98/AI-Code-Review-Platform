                            ...
                            <DropdownMenuTrigger asChild>
                                <SidebarMenuButton
                                    ...
                                    <div className="grid flex-1 text-left text-sm leading-relaxed min-w-0">
                                        ...
                                        <span className="truncate text-xs text-sidebar-foreground/70">{userEmail}</span> </div>
                                </SidebarMenuButton>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                                ...
                                <div className="px-2 py-3 border-t border-b">
                                    <DropdownMenuItem asChild>
                                        <button
                                            ...
                                            {theme == "dark" ? (
                                                <>
                                                    <Sun className="w-5 h-5 shrink-0" /> <span>Light Mode</span>
                                                </>) : (
                                                <>
                                                    <Moon className="w-5 h-5 shrink-0" /> <span>Dark Mode</span>
                                                </>)}
                                        </button>
                                    </DropdownMenuItem>
